...
const ConnectPage = () => {
  ...
  const ConnectPageCallback = async () => {
  ...
  return (
    <div className="flex min-h-screen w-full animate-[fadeIn_5s_ease-in-out] select-none flex-col items-center justify-center">
      <div className="group relative flex items-center justify-center">
        ...
        <div
          className="relative flex cursor-pointer items-center justify-center rounded-md border border-slate-500 bg-gray-100 from-[#bef1eb] to-[#36dbb5] px-3 py-1 text-xl font-thin text-slate-600 hover:border-white/50 hover:bg-gradient-to-tl hover:text-white xl:px-6 xl:py-2 xl:text-5xl"
          onClick={() => {
            {
              !isAuthenticated
                ? authenticate({
                    signingMessage: '🗻 SIGN-IN TO PLAY 🪐 OSIRIS 🗻',
                    onSuccess: ConnectPageCallback,
                  })
                : logout()
            }
          }}
        >
          <div className="flex items-center justify-center space-x-4">
            <svg
              className="mr-2 -ml-1 h-10 w-12 items-center justify-center"
